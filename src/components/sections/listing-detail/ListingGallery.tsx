  ...
  const tiles = React.useMemo(
    () =>
      GRADIENT_VARIANTS.map((tone, i) => ({
        id: i,
        tone,
        // mix in the listing's base tone for the first tile so it reads as the cover
        firstTile: i === 0,
      })),
    [],
  );
        ...
        {open && openIndex !== null && (
          ...
          >
            ...
            <motion.div
              ...
              className={cn(
                "relative aspect-[4/3] w-[min(90vw,1200px)] max-h-[80vh] overflow-hidden rounded-[18px] bg-gradient-to-br",
