...
export const draft: Insight = {
  slug: "how-to-sell-a-hotel-2026",
  kind: "white-paper",
  title: "The Complete Guide to Selling Your Hotel in 2026",
  subtitle:
  ...
  excerpt:
    "Selling a U.S. hotel in 2026 takes 22 to 28 weeks from engagement letter signature to closing wire for a typical select-service asset, with broker fee structures sliding from approximately 2.0 to 2.5 percent at the lower end of single-asset deal sizes down to 1.0 to 1.5 percent on portfolios above $100 million. The two questions that determine outcome are settled before marketing launches: pre-listing PIP strategy and debt assumption versus payoff. This is the working playbook our team uses with sellers in 2026.",
  body: [
  ...
  tldr: [
    "Selling a U.S. select-service hotel in 2026 takes 22 to 28 weeks from engagement letter to closing wire (PwC Hospitality Directions US, Dec 2025).",
    "Industry-typical broker fees: 2.0 to 2.5% under $10M deal size; sliding to 1.0 to 1.5% above $75M; 0.75 to 1.25% on portfolios above $150M (AHLA member broker survey, 2025).",
    "Pre-listing PIP decision drives 50 to 125 basis points of cap rate impact; the math on complete-vs-sell-as-is should run in the BOV before marketing launches.",
    "Assumable debt at coupon spreads above 100 bps below market compresses cap rates 25 to 75 bps; below 50 bps spread typically supports payoff strategy.",
    "Sun Belt secondary stabilized select-service produced 6 to 14 first-round bids in Q1 2026, up from 3 to 7 in 2024 (Matthews transaction file).",
    "Three franchisors (Hilton, Marriott, IHG) require 60 to 120 days for buyer transfer approval; the process is a closing condition on every branded deal.",
  ],
  faq: [
    {
      q: "How long does it take to sell a hotel in 2026?",
      a: "A typical single-asset, fee-simple select-service hotel disposition in 2026 takes 22 to 28 weeks from engagement letter signature to closing wire (PwC Hospitality Directions US, December 2025). Portfolios run 30 to 40 weeks. The 24-week median assumes a clean title commitment, a confirmed brand-standards letter, and either debt-free or assumable-debt status at engagement.",
    },
    {
      q: "What is the typical broker fee for selling a hotel?",
      a: "Industry-typical hotel investment sales broker fees slide by deal size: 2.0 to 2.5 percent under $10M, 1.5 to 2.0 percent for $10M to $30M, 1.25 to 1.75 percent for $30M to $75M, 1.0 to 1.5 percent for $75M to $150M, and 0.75 to 1.25 percent for portfolios above $150M (AHLA member broker survey, 2025; verified across multiple national broker disclosures). Fees are payable at closing from seller proceeds.",
    },
    {
      q: "Should I complete the PIP before listing my hotel for sale?",
      a: "It depends on the math. A property facing a $1.5M PIP at a 7.75 percent post-renovation cap rate carries approximately $2.25M to $3M of buyer-applied valuation drag versus the headline PIP cost. Sellers with construction expertise and capital availability often complete the PIP pre-sale and capture the spread; sellers without those advantages typically price the PIP into the cap rate and sell as-is. Run both scenarios in the BOV before deciding.",
    },
    {
      q: "When does loan assumption make sense versus payoff?",
      a: "Loan assumption preserves below-market debt for the buyer and can compress cap rates 25 to 75 basis points but introduces a 60 to 120 day lender approval timeline, a 1 percent assumption fee, and lender approval risk. Spreads of in-place coupon below market above 100 basis points typically support assumption strategy; spreads below 50 basis points support payoff. Sellers carrying CMBS with material defeasance cost should run the full scenario.",
    },
    {
      q: "How many bids should I expect for a Sun Belt select-service hotel in 2026?",
      a: "A stabilized PIP-current select-service hotel in a Sun Belt secondary market typically produces 6 to 14 first-round bids in Q1 2026, up from 3 to 7 in 2024 (Matthews Hotel Markets transaction file). Trophy assets and tight Sun Belt urban full-service produce 15 to 25. The bid count is itself a leading indicator of execution certainty.",
    },
    {
      q: "When should I NOT sell my hotel?",
      a: "Three situations argue against 2026 disposition: (a) mid-PIP-cycle without capital to complete pre-sale, where the value drag exceeds the carry cost of holding two years; (b) in-place debt at a coupon materially below market and not assumable, where prepayment penalty consumes equity; (c) the asset is a strategic hold whose disposition creates concentration gaps in the broader portfolio. In these cases, refinancing and holding through the next cycle is often the better answer.",
    },
    {
      q: "What is the franchisor approval timeline for a hotel sale?",
      a: "Hilton, Marriott, and IHG each require buyer approval for franchise transfer, with documented timelines of 60 to 120 days from receipt of a complete franchise application. Approval is a closing condition; the deal does not close without it. Conditional approvals typically require buyer commitment to a defined PIP scope and timeline. The process should be initiated at PSA execution to avoid extending the closing date.",
    },
  ],
  sources: [
    {
      label: "PwC Hospitality Directions US, December 2025",
      url: "https://www.pwc.com/us/en/industries/consumer-markets/hospitality-leisure.html",
      publisher: "PricewaterhouseCoopers",
    },
    {
      label: "HVS US Market Pulse, April 2026",
      url: "https://www.hvs.com/article/9869",
      publisher: "HVS",
    },
    {
      label: "CBRE H2 2025 Hotel Cap Rate Survey",
      url: "https://www.cbre.com/insights/reports/us-cap-rate-survey-h2-2025",
      publisher: "CBRE Research",
    },
    {
      label: "JLL Hotels & Hospitality, US Hotel Investment Outlook 2026",
      url: "https://www.us.jll.com/en/trends-and-insights/research/hotel-investment-outlook",
      publisher: "JLL Hotels Research",
    },
    {
    ...
    {
      label: "Trepp 2026 Hotel CMBS Maturity Outlook (public summaries)",
      url: "https://www.trepp.com/trepptalk",
      publisher: "Trepp",
    },
    {
      label: "AAHOA Member Survey on Hotel Transactions, 2025",
      url: "https://www.aahoa.com/research",
      publisher: "Asian American Hotel Owners Association",
    },
    {
  ...
  keyStats: [
    {
      value: "22–28 weeks",
      label: "Engagement letter to closing wire, single-asset select-service",
      source: "PwC Hospitality Directions US, December 2025",
    },
    {
      value: "1.0%–2.5%",
      label: "Industry-typical broker fee range, sliding by deal size",
      source: "AHLA member broker survey, 2025",
    },
    {
      value: "60–120 days",
      label: "Franchisor approval window for buyer transfer",
      source: "Hilton, Marriott, IHG franchise transfer documentation",
    },
    {
      value: "6–14",
      label: "First-round bids for typical Sun Belt secondary stabilized select-service, Q1 2026",
      source: "Matthews Hotel Markets transaction file, 2025–Q1 2026",
    },
    {
      value: "$30B",
      label: "U.S. hotel CMBS maturing through year-end 2027",
      source: "Trepp public summaries, 2026",
    },
    {
      value: "50–125 bps",
      label: "Cap rate widening for PIP-overhang vs. PIP-current peers",
      source: "Matthews transaction file + HVS US Market Pulse, 2026",
    },
    {
      value: "25–75 bps",
      label: "Cap rate compression for assumable debt at >100 bps below market",
      source: "Matthews transaction file, 2025–Q1 2026",
    },
    {
      value: "9–12 months",
      label: "Standard exclusivity period in hotel investment sales engagement letters",
      source: "Industry-typical engagement letter terms, 2025",
    },
    {
      value: "30–60 days",
      label: "Standard buyer due diligence period after PSA execution",
      source: "ALTA-form hotel PSA precedent, 2025",
    },
    {
      value: "~1%",
      label: "Typical CMBS / bank loan assumption fee on UPB",
      source: "Trepp 2026; CMBS originator term sheets",
    },
  ],
  relatedMarkets: [
    "austin-tx",
  ...
  relatedBrands: ["hampton-inn", "holiday-inn-express", "marriott", "hilton", "ihg"],
  relatedInsights: [
