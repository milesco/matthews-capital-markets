...
export const draft: Insight = {
  ...
  kind: "outlook",
  title: "Texas Hotel Cap Rates Q2 2026: What Owners Should Expect",
  subtitle:
  ...
  excerpt:
    "Texas hotel cap rates compressed roughly 25 to 50 basis points off the 2024 peak through the first half of 2026, with stabilized PIP-current select-service in the Texas Triangle pricing in the 7.50 to 8.75 percent range. Owners weighing a sale, refinance, or hold this quarter need to read the cap rate band by metro, by segment, and by sub-market.",
  body: [
  ...
  tldr: [
    "Texas hotel cap rates compressed 25 to 50 basis points off the 2024 peak through H1 2026.",
    "Austin stabilized select-service prices in the 7.50 to 8.25 percent range, the tightest in the state.",
    "Houston carries the widest band at 7.75 to 8.75 percent on energy-cycle exposure.",
    "Riverwalk full-service prices at 6.75 to 7.50 percent, the tightest urban cap rate in Texas.",
    "Hotel CMBS spreads tightened through Q4 2025 and have held tight through 2026 to-date.",
    "We expect 25 additional basis points of compression in Texas Triangle select-service through year-end 2026 if rates hold.",
  ],
  faq: [
    {
      q: "What is a typical hotel cap rate in Texas in Q2 2026?",
      a: "Stabilized PIP-current select-service in the Texas Triangle (Austin, Dallas-Fort Worth, Houston, San Antonio) prices in the 7.50 to 8.75 percent range. Full-service in primary metros prices in the 7.00 to 8.00 percent range. Hill Country resort assets and Riverwalk full-service trade tighter, in the 6.50 to 7.75 percent band [Source: Matthews internal transaction database, Q2 2026].",
    },
    {
      q: "Where are Austin hotel cap rates today?",
      a: "Austin stabilized select-service prices in the 7.50 to 8.25 percent cap range. Full-service downtown and Domain-area assets price in the 7.00 to 8.00 percent range. Hill Country resort assets, where the supply pipeline is structurally constrained, trade in the 6.50 to 7.75 percent range as of Q2 2026.",
    },
    {
      q: "Why are Houston hotel cap rates wider than Dallas or Austin?",
      a: "Houston carries an energy-cycle premium that the institutional bid prices in even when the energy cycle is benign. Stabilized select-service runs 7.75 to 8.75 percent. The exception is Texas Medical Center proximity, which trades roughly 50 basis points tighter than the metro average on the strength of medical, research, and patient-family demand.",
    },
    {
      q: "Are Texas hotel cap rates expected to compress further in 2026?",
      a: "Yes, if the rate environment holds. We expect roughly 25 additional basis points of compression in Texas Triangle stabilized select-service through year-end 2026. The compression is driven by a constrained supply pipeline through 2027, tightened CMBS spreads, and family-office and developer-sponsor capital actively deploying at current pricing.",
    },
    {
      q: "How do Texas cap rates compare to the national cap rate band?",
      a: "Texas runs roughly 25 basis points tighter than the national mid-band for stabilized select-service, which prices 7.75 to 9.00 percent nationally per HVS Q2 2026 data. The premium reflects Texas population and employment growth that continues to outrun the national average and a constrained Texas construction pipeline through 2027.",
    },
    {
      q: "Should I sell my Texas hotel in 2026 or refinance?",
      a: "Run both paths in parallel. The cap rate band has compressed enough off the 2024 peak that selling at current pricing frequently produces equity recovery comparable to refinancing with a fresh equity check, with the upside of redeploying into a new vintage. The right answer depends on your forward RevPAR view, your equity availability, and the asset's PIP timing.",
    },
    {
      q: "What is the cap rate for Hill Country resort hotels?",
      a: "Hill Country and coastal Texas resort assets trade in the 6.50 to 7.75 percent cap range on stabilized cash flow as of Q2 2026, the tightest band in the state. The compression reflects supply moats (land and entitlement constraints), structural demand from Austin and DFW drive markets, and the maturing institutional bid for lifestyle hospitality product.",
    },
  ],
  sources: [
    {
      label: "HVS U.S. Market Pulse",
      url: "https://www.hvs.com/article/category/2-hvs-market-pulse",
      publisher: "HVS",
    },
    {
    ...
    },
    {
      ...
      url: "https://www.cbre.com/insights/reports/us-hotels-outlook-2026",
      publisher: "CBRE",
    },
    {
      label: "JLL Hotels & Hospitality Research",
      url: "https://www.jll.com/en/industries/hotels-and-hospitality",
      publisher: "JLL",
    },
    {
    ...
    {
      label: "Trepp CMBS Surveillance",
      url: "https://www.trepp.com/insights",
      publisher: "Trepp",
    },
    {
  ...
  keyStats: [
    {
      value: "25–50 bps",
      label: "Texas Triangle cap rate compression off 2024 peak, H1 2026",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "7.50–8.25%",
      label: "Austin stabilized select-service cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "7.75–8.75%",
      label: "Houston stabilized select-service cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "6.75–7.50%",
      label: "San Antonio Riverwalk full-service cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "6.50–7.75%",
      label: "Austin Hill Country resort cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "~$30B",
