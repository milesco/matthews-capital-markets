...
export const draft: Insight = {
  slug: "hotel-cmbs-distress-trepp-2026",
  kind: "white-paper",
  title: "Hotel CMBS Distress: How to Read the Trepp Public Data in 2026",
  subtitle:
  ...
  excerpt:
    "Trepp's monthly CMBS report is the single best public window into hotel-loan distress. The March 2026 release put the lodging delinquency rate at 7.31 percent, up 137 basis points in a single month, while the lodging special-servicing rate sat at 9.37 percent in January 2026. Reading those two series together — alongside the maturity calendar, modification volume, and liquidated-loan loss severities — tells investors where the distressed hotel acquisition opportunity is real and where it has already been priced.",
  body: [
    ...
    "Refreshed monthly when Trepp publishes. Submitted to print May 10, 2026.",
  ].join("\n\n"),
  downloadHref: "#",
  tags: ["CMBS", "Distress", "Trepp", "Special Servicing", "Capital Markets"],
  tldr: [
    "Lodging CMBS delinquency hit 7.31% in March 2026, up 137 bps month-over-month after a 105-bps January drop (Trepp).",
    "Lodging special-servicing rate sat at 9.37% in January 2026, down from a 10.61% October 2025 peak — the highest since March 2022.",
    "Roughly 30% of CMBS loans backed by hotels mature in 2026; lodging is 20.5% of the $76.6B hard-maturity book and carries the highest weighted-average debt yield at 12.93%.",
    "Modifications dominate workout outcomes; the Starwood $577M and $265M portfolios are the cycle's defining names.",
    "Distress is concentrated in full-service urban CBD; stabilized Sun Belt secondary select-service is clearing through refinance and sale.",
    "Refinance proceeds gap for representative 2018-vintage loans runs 12-20% of prior balance at current cap rates and tighter LTVs.",
  ],
  faq: [
    {
      q: "What is the current hotel CMBS delinquency rate?",
      a: "The lodging CMBS delinquency rate was 7.31% in March 2026, up 137 basis points month-over-month from 5.94% in February. The series printed 5.56% in January 2026 after declining 105 bps from December. On a year-over-year basis, March 2026 was up 12 bps from March 2025 (Source: Trepp via MBA NewsLink, April 2026).",
    },
    {
      q: "What is the hotel CMBS special-servicing rate?",
      a: "The lodging special-servicing rate sat at 9.37% in January 2026, down 11 bps month-over-month. The series peaked at 10.61% in October 2025 — the highest level since March 2022 — before stepping down through Q4 2025 as modifications cleared the workout pipeline (Source: Trepp via Connect CRE; Commercial Real Estate Direct).",
    },
    {
      q: "What triggers a hotel loan transfer to special servicing?",
      a: "Five triggers: imminent monetary default, DSCR covenant breach (typically a 1.10x or 1.20x minimum for two consecutive quarters), loan maturity without refinance commitment, brand or franchise termination, and borrower request for modification. Maturity-driven transfers are dominant in 2026.",
    },
    {
      q: "How big is the 2026 hotel CMBS maturity wall?",
      a: "Approximately 30% of CMBS loans backed by hotel/motel properties mature in 2026. Lodging accounts for 20.5% of the $76.6B in 2026 hard maturities and carries the highest weighted-average debt yield in the book at 12.93% (Source: The Real Deal citing Trepp, January 2026; KBRA 2026 CMBS Outlook).",
    },
    {
      q: "Are most distressed hotel CMBS loans being modified or liquidated?",
      a: "Modified. The 2024-2026 cycle has favored A/B note structures, hope-note modifications, and partial-payoff extensions over liquidation. The Starwood $577M portfolio modification (63 hotels, 21 states) and the $265M Midwest portfolio modification are the cycle's defining workouts. Liquidations have been smaller and more episodic — roughly $187.3M across all property types in July 2025 (Source: Trepp).",
    },
    {
      q: "Where is the real distressed hotel acquisition opportunity in 2026?",
      a: "Concentrated in mid-tier full-service in tertiary CBDs and in sponsor-led portfolio recapitalizations needing equity rotation. Stabilized select-service in growing Sun Belt secondary markets is clearing through refinance and sale rather than through workout — buyers shopping for distressed Hampton Inns in the Texas Triangle should reset expectations.",
    },
    {
      q: "How do I read the Trepp monthly release efficiently?",
      a: "Read the lodging delinquency and special-servicing prints together. Special servicing rising while delinquency falls signals modifications clearing the pipeline. Cross-reference monthly hard-maturity data against new-transfer volume to separate sponsor-driven pre-modification transfers from lender-driven pre-foreclosure transfers. Watch named SASB transactions; a single $200-500M deal can move the entire lodging series.",
    },
  ],
  sources: [
    {
      label: "Trepp CMBS Delinquency Report (April 2026)",
      url: "https://www.trepp.com",
      publisher: "Trepp",
    },
    {
      label: "MBA NewsLink: Trepp CMBS Delinquency Rate Increases (April 2026)",
    ...
    {
      label: "Connect CRE: CMBS Special Servicing Rate Begins 2026 with Increase",
      url: "https://www.connectcre.com/stories/cmbs-special-servicing-rate-begins-2026-with-increase/",
      publisher: "Connect CRE",
    },
    {
      label: "CRE Daily: CMBS Loans Face $100B Maturity Wall in 2026",
      url: "https://www.credaily.com/briefs/cmbs-loans-face-100b-maturity-wall-in-2026/",
      publisher: "CRE Daily",
    },
    {
      label: "CRE Daily: Starwood Wants to Restructure $577M Hotel CMBS Loan",
      url: "https://www.credaily.com/briefs/starwood-wants-to-restructure-577m-hotel-cmbs-loan/",
      publisher: "CRE Daily",
    },
    {
      label: "Connect CRE: Park Hotels Walks Away from $725M CMBS",
      url: "https://www.connectcre.com/stories/park-hotels-walks-away-from-725m-cmbs-on-two-san-francisco-properties/",
      publisher: "Connect CRE",
    },
    {
      label: "KBRA 2026 U.S. CMBS Outlook",
      url: "https://www.kbra.com/publications/dncMHcjj",
  ...
  keyStats: [
    {
      value: "7.31%",
      label: "Lodging CMBS delinquency rate, March 2026",
      source: "Trepp via MBA NewsLink, April 2026",
    },
    {
      value: "9.37%",
      label: "Lodging special-servicing rate, January 2026",
      source: "Trepp via Connect CRE, February 2026",
    },
    {
      value: "10.61%",
      label: "Lodging special-servicing peak, October 2025 (highest since March 2022)",
      source: "Trepp via Commercial Real Estate Direct, December 2025",
    },
    {
      value: "30%",
      label: "Share of CMBS hotel loans maturing in 2026",
      source: "CRE Daily citing Trepp, 2026",
    },
    {
      value: "$76.6B",
      label: "Total CMBS hard maturities in 2026; lodging is 20.5% of the book",
      source: "The Real Deal citing Trepp, January 2026",
    },
    {
      value: "12.93%",
      label: "Weighted-average debt yield on lodging hard-maturity loans (highest in the book)",
      source: "The Real Deal citing Trepp, January 2026",
    },
    {
      value: "$577M",
      label: "Starwood Capital portfolio CMBS modification, 63 hotels across 21 states",
      source: "CRE Daily, 2025",
    },
    {
      value: "4.43%",
      label: "10-year U.S. Treasury yield, May 5, 2026",
  ...
  relatedBrands: ["hampton-inn", "holiday-inn-express", "hilton-garden-inn"],
  relatedInsights: [
