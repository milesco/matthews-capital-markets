...
export const draft: Insight = {
  slug: "brand-flag-cap-rate-guide-2026",
  kind: "white-paper",
  title:
  ...
  excerpt:
    "Stabilized PIP-current Hampton Inns, Holiday Inn Express, and Marriott select-service flags are clearing the market in a 7.25 to 8.75 percent cap range as of Q2 2026, with Sun Belt secondary trading roughly 75 basis points wider than primary urban and tertiary trading another 50 to 100 basis points wider than that. Royalty load, PIP-cycle timing, and loyalty contribution explain most of the within-brand spread. This is the working guide our team uses to brief sellers and buyers in the first call.",
  body: [
  ...
  tldr: [
    "Stabilized PIP-current Hampton Inns, Holiday Inn Express, and Marriott select-service flags are clearing in a 7.25 to 8.75 percent cap range in 2026 (HVS US Market Pulse, April 2026).",
    "Sun Belt secondary trades roughly 75 basis points wider than primary urban; tertiary trades another 50 to 100 basis points wider than secondary.",
    "Hampton attracts the broadest buyer pool, compressing cap rates 25 to 50 basis points vs. comparable HIE and Marriott select in the same market.",
    "Effective franchise load: Hampton ~10%, HIE 9.5 to 10%, Marriott select 8 to 11% depending on flag (FDDs filed 2025, public via state filings).",
    "PIP-overhang assets (renovation due within 18 months) trade 50 to 125 bps wider than PIP-current peers in the same market.",
    "TownePlace Suites and other extended-stay select-service flags trade 25 to 50 bps tighter than upper-midscale comparables on the back of consistent 2024-2025 extended-stay performance (STR).",
  ],
  faq: [
    {
      q: "What cap rate should I expect for a stabilized Hampton Inn in a Sun Belt secondary market in 2026?",
      a: "Stabilized PIP-current Hampton Inns in Sun Belt secondary markets are clearing in a 7.50 to 8.50 percent cap range as of Q2 2026 (HVS US Market Pulse, April 2026; CBRE H2 2025 Cap Rate Survey). Properties with a recent franchise license extension and an STR index above 105 trade at the tight end; properties facing a PIP within 18 months trade 50 to 125 basis points wider.",
    },
    {
      q: "How does Holiday Inn Express pricing compare to Hampton in the same market?",
      a: "Holiday Inn Express typically trades 25 to 50 basis points wider than a comparable Hampton in the same market in 2026. The delta reflects two things: the loyalty mix differential (Hilton Honors at Hampton runs 60 to 70 percent of room nights vs. IHG One Rewards at HIE running 50 to 60 percent, per each franchisor's investor presentations) and IHG Express renovation overhang on properties that have not yet completed the program.",
    },
    {
      q: "What is the effective franchise load for Marriott select-service flags?",
      a: "Per Marriott's most recently filed franchise disclosure documents (issued 2025, public via state filings): Fairfield Inn & Suites runs an effective franchise load of 8 to 9 percent of gross room revenue, Courtyard 10 to 11 percent, SpringHill Suites 9 to 10 percent, TownePlace Suites 8 to 9 percent. The load includes royalty, marketing program fees, reservation contribution, and Bonvoy loyalty charges.",
    },
    {
      q: "Why do extended-stay select-service flags like TownePlace Suites trade tighter than upper-midscale Fairfield or Hampton?",
      a: "Extended-stay product has produced more consistent occupancy and ADR through the 2024 and 2025 cycle than upper-midscale select-service in the same markets (STR extended-stay performance reports, 2025). The performance consistency translates into 25 to 50 basis points of cap rate compression for stabilized TownePlace, Residence Inn, Staybridge, and WoodSpring assets relative to upper-midscale select-service in the same market.",
    },
    {
      q: "How should I price a select-service hotel facing a PIP within 18 months?",
      a: "Buyers price PIP exposure by deducting the full undepreciated PIP cost from value at the post-renovation cap rate, then adding back a construction risk and time discount. The implied valuation drag for a property facing a $1.5 million PIP within 18 months is typically 1.5 to 2.0 times the headline PIP cost. Practical effect: PIP-overhang assets clear 50 to 125 basis points wider than PIP-current peers.",
    },
    {
      q: "Who is the buyer pool for Sun Belt secondary select-service hotels in 2026?",
      a: "The pool clusters in four tiers. Dedicated select-service REITs (Apple Hospitality, Summit Hotel Properties, Chatham Lodging Trust, Service Properties Trust). PE select-service roll-ups for portfolios in the $50 to $300 million range. Family offices for single-asset deals in the $8 to $25 million range. AAHOA-network owner-operators for smaller secondary and tertiary deals. Hampton attracts the broadest pool of the three flag families.",
    },
    {
      q: "Where are tertiary-market select-service cap rates in 2026?",
      a: "Tertiary-market select-service hotels are trading in an 8.50 to 9.75 percent cap range across all three flag families. The drivers: smaller buyer pool (primarily owner-operators and AAHOA-network buyers), lower transaction frequency, more variable franchise license extension outcomes, and thinner NOI margin against the same fixed franchise load.",
    },
  ],
  sources: [
    {
    ...
    {
      label: "JLL Hotels & Hospitality Group, US Hotel Investment Outlook 2026",
      url: "https://www.us.jll.com/en/trends-and-insights/research/hotel-investment-outlook",
      publisher: "JLL Hotels Research",
    },
    {
      label: "Hilton 2024 Annual Report (10-K)",
      url: "https://ir.hilton.com/financial-reporting/annual-reports",
      publisher: "Hilton Worldwide Investor Relations",
    },
    {
      label: "Marriott International 2024 Annual Report (10-K)",
      url: "https://www.marriott.com/marriott/aboutmarriott.mi",
      publisher: "Marriott International Investor Relations",
    },
    {
      label: "InterContinental Hotels Group 2024 Annual Report",
      url: "https://www.ihgplc.com/en/investors/annual-report",
      publisher: "IHG Investor Relations",
    },
    {
  ...
  keyStats: [
    {
      value: "7.25%–8.75%",
      label: "Stabilized PIP-current select-service cap range, Q2 2026",
      source: "HVS US Market Pulse, April 2026",
    },
    {
      value: "~2,800",
      label: "Hampton Inn family properties open globally",
      source: "Hilton 2024 10-K",
    },
    {
      value: "~2,300",
      label: "Holiday Inn Express properties in the U.S.",
      source: "IHG 2024 annual report",
    },
    {
      value: "~10%",
      label: "Hampton Inn effective franchise load (royalty + program fees)",
      source: "Hilton FDD, filed 2025",
    },
    {
      value: "60–70%",
      label: "Hilton Honors share of room nights at stabilized U.S. Hampton",
      source: "Hilton investor presentations, Q4 2025",
    },
    {
      value: "50–60%",
      label: "IHG One Rewards share of room nights at stabilized U.S. HIE",
      source: "IHG investor day, 2024–2025",
    },
    {
      value: "55–65%",
      label: "Bonvoy share at stabilized U.S. Marriott select-service",
      source: "Marriott 2024 10-K",
    },
    {
      value: "$12K–$40K/key",
      label: "PIP cost range across Hampton, HIE, and Marriott select",
      source: "FDD-disclosed renovation requirements, 2025 filings",
    },
    {
      value: "50–125 bps",
      label: "PIP-overhang valuation discount vs. PIP-current peers",
      source: "Matthews Hotel Markets transaction file, 2025–Q1 2026",
    },
    {
      value: "$130K–$170K/key",
      label: "Sun Belt secondary stabilized select-service per-key band, Q1 2026",
      source: "REIT supplemental data + LODGING / Hotel News Now press coverage",
    },
  ],
  relatedMarkets: [
    "austin-tx",
