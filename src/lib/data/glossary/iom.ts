...
export const entry: GlossaryEntry = {
  slug: "iom",
  term: "IOM / Investment Memorandum / OM",
  shortDef:
  ...
  fullDef:
    "An investment offering memorandum (IOM, OM, or IM) is the principal marketing document used in a hotel disposition. It presents the property, market, financial performance, and investment thesis to qualified buyers under NDA. A typical hotel OM runs 40 to 80 pages and includes property summary, market analysis, financial detail, transaction comps, and investment highlights.",
  body: [
  ...
  faq: [
    {
      q: "What is the difference between an IOM, an OM, and an IM?",
      a: "All three terms refer to the same document. Investment offering memorandum (IOM), offering memorandum (OM), and information memorandum (IM) are used interchangeably across hotel investment-sales brokerages. CBRE, JLL, HVS, Marcus & Millichap, and Eastdil Secured all use slightly different conventions, but the document is the same.",
    },
    {
      q: "How long is a typical hotel OM?",
      a: "Select-service OMs typically run 40 to 60 pages. Full-service and resort OMs run 60 to 100 pages. Portfolio OMs covering multiple assets can exceed 150 pages. Length is driven by the complexity of the asset, the depth of the market analysis, and the volume of operating data.",
    },
    {
      q: "When is the OM distributed during a hotel sale?",
      a: "After listing engagement and after the buyer pool has been qualified and NDAs executed. The standard sequence is: listing engagement, OM production (typically two to four weeks), teaser distribution, NDA execution with interested parties, OM release, LOI process. OMs are not pre-released to buyers without NDA.",
    },
    {
      q: "What information does an OM include that a BOV does not?",
      a: "OMs include marketing-quality photography, full physical-condition documentation, detailed franchise and brand-standards summaries, transaction process and timeline, expanded comparable-sales analysis, and contact information for the broker team. BOVs are internal underwriting documents focused on valuation; OMs are external marketing documents focused on transaction execution.",
    },
    {
      q: "Can a buyer rely on the OM during due diligence?",
      a: "Buyers should treat the OM as the starting point for underwriting, not the final word. Independent due diligence on financials (third-party audit or accountant review), STR reports, franchise standing letters, PIP letters, environmental reports, and physical-condition assessments is standard. Material discrepancies between OM data and due diligence findings are the most common cause of price re-trade or deal break.",
    },
  ],
  sources: [
    {
      label: "HVS Hotel Sales Process Resources",
    ...
    {
      label: "Offering Memorandum Definition",
      url: "https://www.investopedia.com/terms/o/offeringmemorandum.asp",
