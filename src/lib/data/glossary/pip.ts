...
export const entry: GlossaryEntry = {
  ...
  fullDef:
    "A property improvement plan (PIP) is a franchise-issued list of required capital upgrades a hotel owner must execute to keep, renew, or transfer a brand license. PIPs cover guest rooms, public space, exterior, FF&E, and brand-standard technology. Costs typically run $15,000 to $40,000 per key for select-service and substantially higher for full-service.",
  body: [
  ...
  faq: [
    {
      q: "How much does a hotel PIP cost?",
      a: "Select-service PIPs typically run $15,000 to $40,000 per key depending on brand, scope, and renovation cycle stage. Full-service PIPs can exceed $75,000 per key. New brand-design rollouts, like Hilton's H4 Hampton refresh or IHG's Express Renovation program, push costs to the higher end of the range.",
    },
    {
      q: "How often are PIPs required?",
  ...
  sources: [
    ...
    {
      label: "Hospitality Net PIP Coverage",
      url: "https://www.hospitalitynet.org/news/term/property-improvement-plan.html",
