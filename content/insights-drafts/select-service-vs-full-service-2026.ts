...
export const draft: Insight = {
  ...
  kind: "white-paper",
  title:
    "Select-Service vs Full-Service Hotels: 2026 Capital Markets Outlook",
  subtitle:
  ...
  excerpt:
    "Select-service hotel transactions are clearing at materially tighter cap rates than full-service in 2026, and the gap is widening rather than narrowing. The divergence is structural, not cyclical, and capital markets executions reflect it: select-service refinancings close at attachment points that full-service workouts cannot reach.",
  body: [
  ...
  tldr: [
    "Sun Belt secondary stabilized select-service prices 7.50 to 8.50 percent in Q2 2026.",
  ...
  sources: [
    ...
    {
      label: "Apple Hospitality REIT Investor Relations",
      url: "https://ir.applehospitalityreit.com/",
      publisher: "Apple Hospitality REIT",
    },
    {
      label: "LODGING Magazine",
      url: "https://lodgingmagazine.com/",
      publisher: "AHLA / LODGING",
    },
  ],
  keyStats: [
    {
      value: "7.50–8.50%",
      label: "Sun Belt secondary stabilized select-service cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "7.00–8.00%",
      label: "Primary-metro stabilized full-service cap range",
      source: "Matthews internal transaction database, Q2 2026",
    },
    {
      value: "9.00–10.50%",
      label: "Tertiary-CBD stabilized full-service cap range",
      source: "HVS U.S. Market Pulse, April 2026",
    },
    {
      value: "220+",
      label: "Apple Hospitality REIT upscale select-service hotels",
    ...
    {
      value: "<60 days",
      label: "Typical institutional underwriting timeline for stabilized select-service",
      source: "Matthews capital markets practice",
    },
  ],
  relatedMarkets: [
    "austin-tx",
