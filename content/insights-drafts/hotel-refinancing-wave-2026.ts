...
export const draft: Insight = {
  slug: "hotel-refinancing-wave-2026",
  kind: "white-paper",
  ...
  tldr: [
    ...
    "Owners facing 2026–2027 maturities should run BOVs and refinance evaluations in parallel before the maturity calendar dictates the outcome.",
  ],
  faq: [
    {
  ...
  sources: [
    ...
    {
      label: "MBA Commercial / Multifamily Mortgage Maturities, February 2025",
      url: "https://www.mba.org/news-and-research/research-and-economics/commercial-multifamily-research",
    ...
    {
      label: "JLL Hotels & Hospitality Q1 2026 Capital Markets Update",
      url: "https://www.us.jll.com/en/trends-and-insights/research/hotels",
      publisher: "JLL",
    },
    {
    ...
    {
      label: "Mortgage News Daily Mortgage Rate Survey, May 9 2026",
  ...
  keyStats: [
    ...
    {
      value: "7.40%",
      label: "Hotel CMBS delinquency rate, Q1 2026 close",
      source: "Trepp, April 2026 monthly report",
    },
    {
      value: "4.36%",
      label: "10-year Treasury yield, May 9 2026",
      source: "Federal Reserve H.15",
    },
    {
      value: "6.85%",
      label: "30-year fixed mortgage rate, May 9 2026",
    ...
    {
      value: "$957B",
      label: "2025 commercial / multifamily mortgage maturities scheduled",
      source: "MBA, February 2025",
    },
    {
      value: "12–20%",
      label: "Estimated proceeds-to-payoff gap on a meaningful share of the maturing book",
      source: "Matthews analysis of HVS / Trepp public data",
    },
    {
      value: "8.50–10.25%",
      label: "All-in hotel bridge debt coupon, Q2 2026",
      source: "Matthews capital markets dialogue",
    },
  ],
  relatedMarkets: [
    "austin-tx",
